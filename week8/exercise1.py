...
def put_behind_bars(input_string="very naughty boy"):
    ...
    """
    barstring = "|"
    return barstring + (barstring.join(input_string)) + barstring
    print (barstring + (barstring.join(input_string)) + barstring)
