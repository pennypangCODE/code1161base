...
def diarist():
    ...
    """
    gcodeFile = open('week4/Trispokedovetiles(laser).gcode', 'r')
    newFile = open('week4/lasers.pew', 'w')

    count = 0

    for robotz in gcodeFile.readlines():
        if "M10 P1" in robotz:
            count = count + 1
